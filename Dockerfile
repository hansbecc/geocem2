...
COPY src /usr/src/geocem2/
WORKDIR /usr/src/geocem2
...
RUN chmod +x /usr/src/geocem2/tasks.py \
    && chmod +x /usr/src/geocem2/entrypoint.sh
...
# ENTRYPOINT /usr/src/geocem2/entrypoint.sh
